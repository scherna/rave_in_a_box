...
HD_PWD='/afs/athena.mit.edu/user/c/h/cherna/Documents/fft_demo/fft_demo.runs/chroma_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chroma_fifo.vds -m64 -mode batch -messageDb vivado.pb -notrace -source chroma_fifo.tcl
