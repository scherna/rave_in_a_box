...
HD_PWD='/afs/athena.mit.edu/user/c/h/cherna/Documents/fft_demo/fft_demo.runs/hanning_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hanning.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hanning.tcl
