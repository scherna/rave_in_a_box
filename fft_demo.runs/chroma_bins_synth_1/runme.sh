...
HD_PWD='/afs/athena.mit.edu/user/c/h/cherna/Documents/fft_demo/fft_demo.runs/chroma_bins_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chroma_bins.vds -m64 -mode batch -messageDb vivado.pb -notrace -source chroma_bins.tcl
