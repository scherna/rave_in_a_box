set_property SRC_FILE_INFO {cfile:/afs/athena.mit.edu/user/c/h/cherna/Documents/fft_demo/fft_demo.srcs/sources_1/ip/xadc_demo/xadc_demo_ooc.xdc rfile:../../fft_demo.srcs/sources_1/ip/xadc_demo/xadc_demo_ooc.xdc id:1 order:EARLY scoped_inst:inst rxprname:$PSRCDIR/sources_1/ip/xadc_demo/xadc_demo_ooc.xdc} [current_design]
set_property SRC_FILE_INFO {cfile:/afs/athena.mit.edu/user/c/h/cherna/Documents/fft_demo/fft_demo.srcs/sources_1/ip/xadc_demo/xadc_demo.xdc rfile:../../fft_demo.srcs/sources_1/ip/xadc_demo/xadc_demo.xdc id:2 order:EARLY scoped_inst:inst rxprname:$PSRCDIR/sources_1/ip/xadc_demo/xadc_demo.xdc} [current_design]
set_property src_info {type:SCOPED_XDC file:1 line:1 export:INPUT save:INPUT read:FILTER_OUT_OF_CONTEXT} [current_design]
# file: xadc_demo_ooc.xdc
