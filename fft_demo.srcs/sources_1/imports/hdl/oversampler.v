...
module oversample64(
    ...
    always @(posedge clk) begin
        ...
        if (eoc) begin
            ...
            if (&counter) begin // If counter is full (64 accumulated)
                // Get final total, divide by 8 with (very limited) rounding.
                oversample <= (accumulator + sample + 3'b100) >> 3;
                done <= 1;
                // Reset accumulator
                accumulator <= 0;
            end
